...
export default class Allocation extends React.Component {
    ...
    render() {
        if (this.props.lang == '1') {
            this.content = {
                allocationName: 'integrator',
                allocationUsage1: 'gas',
                allocationUsage2: 'pay',
            }
        } else {
            this.content = {
                allocationName: '积分星',
                allocationUsage1: '转账的矿工费需要支付或燃烧ATNL。',
                allocationUsage2: '使用物联网设备需要按照使用的数量和时长支付ATNL',
            }
        }
        return (
                ...
                <div style={{width: "1080px"}}>
                    <div className='allocation_top flex flex_h_s'>
                        <div className='allocation_top_left flex flex_h_c flex_a flex_w' style={{marginLeft: "40px"}}>
                            <p className='allocation_top_left_p1'>ATNL <span>{ this.content.allocationName }</span></p>
                            <div className='allocation_top_left_div'>
                                <p className='allocation_top_left_div_p1'>
                                    { this.content.allocationUsage1 }
                                </p>
                                <p className='allocation_top_left_div_p2'>
                                    { this.content.allocationUsage2 }
                                </p>
                            </div>
                        </div>
                        <div className='allocation_top_right flex flex_h_c flex_a flex_w' style={{marginRight: "40px"}}>
                            <p className='allocation_top_right_p1'>Total ATNL tokens</p>
                            <p className='allocation_top_right_p2'>1,000,000,000</p>
                        </div>
                    </div>
                    <div className='allocation_bottom flex flex_v flex_v_c flex_w flex_a'>
                        <div className='allocation_bottom_top'>
                            <p className='allocation_bottom_top_p1'>预算</p>
                        ...
                        <div className='allocation_bottom_Bottom flex flex_h flex_w flex_h_c'>
                            ...
                            <div className='allocation_bottom_Bottom_center'>
                                <img key={1} className='allocation_bottom_Bottom_center_img'
                                     src={require('../../images/allocation.png')}/>
                                {
                                    this.props.isAllocation ?
                                        <QueueAnim type={'top'} interval={150}>
                                            <img key={2} className='allocation_bottom_Bottom_center_img_1'
                                                 src={require('../../images/allocation_1.png')}/>
                                            <img key={3} className='allocation_bottom_Bottom_center_img_2'
                                                 src={require('../../images/allocation_2.png')}/>
                                            <img key={4} className='allocation_bottom_Bottom_center_img_3'
                                                 src={require('../../images/allocation_3.png')}/>
                                            <img key={5} className='allocation_bottom_Bottom_center_img_4'
                                                 src={require('../../images/allocation_4.png')}/>
                                        </QueueAnim>
                                        : ""
                                }
                            </div>
                            <div className='allocation_bottom_Bottom_right flex flex_w flex_a'>
                                <ul>
                                    <p className='allocation_bottom_Bottom_right_li '><span className='contract'></span>
                                        Ecosystem</p>
                                </ul>
                            </div>
                        </div>
