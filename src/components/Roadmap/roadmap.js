                            ...
                            <QueueAnim type={'bottom'} interval={150} duration={1000} style={{position:"relative",height:"250px"}}>
                                <div key={1} className='Q1Bg'>
                                    <div className='Q1Bg_div flex flex_v flex_a flex_h flex_h_c'>
                                        <p style={{width:"100%",textAlign:"center"}}>ATNL</p>
                                        <p style={{width:"100%",textAlign:"center"}}>注册</p>
                                    </div>
                                </div>
                                <div key={2} className='Q2Bg'>
                                    <div className='Q1Bg_div flex flex_v flex_a flex_h flex_h_c'>
                                        <p style={{width:"100%",textAlign:"center"}}>ATNL Dapp release</p>
                                        <p style={{width:"100%",textAlign:"center"}}>Sign <span style={{fontWeight:"bold"}}>100</span> users </p>
                                        <p style={{width:"100%",textAlign:"center"}}>Covering <span style={{fontWeight:"bold"}}>5</span> areas</p>
                                    </div>
                                </div>
                                <div key={3} className='Q3Bg'>
                                    <div className='Q1Bg_div flex flex_v flex_a flex_h flex_h_c'>
                                        <p style={{width:"100%",textAlign:"center"}}>ATNL Dapp release</p>
                                        <p style={{width:"100%",textAlign:"center"}}>Sign <span style={{fontWeight:"bold"}}>500</span> users </p>
                                        <p style={{width:"100%",textAlign:"center"}}>Covering <span style={{fontWeight:"bold"}}>20</span> areas</p>
                                    </div>
                                </div>
                                <div key={4} className='Q4Bg'>
                                    <div className='Q1Bg_div flex flex_v flex_a flex_h flex_h_c'>
                                        <p style={{width:"100%",textAlign:"center"}}>ATNL Dapp release</p>
                                        <p style={{width:"100%",textAlign:"center"}}>Sign <span style={{fontWeight:"bold"}}>2000</span> users </p>
                                        <p style={{width:"100%",textAlign:"center"}}>Covering <span style={{fontWeight:"bold"}}>100</span> areas</p>
                                    </div>
                                </div>
                            </QueueAnim>
                            :''
